...
#pragma warning restore 649
        ...
        private void OnCollisionStay()
        {
            ...
            else if (_groundCastResults.Any(hit => hit.collider != null && hit.collider.gameObject.layer == 4  )) {
                isSurfing =true;
            }
        ...
        public void Animating(){
            float speed = gameObject.GetComponent<Rigidbody>().velocity.sqrMagnitude;
